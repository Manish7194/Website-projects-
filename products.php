...
<html>
    <head>
        ...
        <style>
        @import url('https://fonts.googleapis.com/css2?family=Iceland&family=Open+Sans&display=swap');
        *,p{
        ...
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    ...
                    <p>All your tech needs satisfied at one place.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
           ...
           <footer class="footer">
               <div class="container">
                <center>
                   <p>Copyright &copy 2022 TechHub<br>All Rights Reserved</p>
               </center>
               </div>
           </footer>
        </div>
